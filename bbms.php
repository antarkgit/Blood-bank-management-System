...
mysqli_select_db($conn,'blood_bank');
  ...
  $statement = "select * from donate where bloodgroup LIKE '%$searchq%'  ";
...
?><body>
  <a href="home.php"style="color:black;font-size: 20px; text-decoration:none; align:center;">Back to home</a>
</body>
