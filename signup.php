  ...
  <html>
   <head>
           <link rel = "icon" href =  "images/down.png" type = "image/x-icon"> 
      ...
      <div class="sign-in-htm">
        ...
        <div class="group">
         ...
         <div class="group">
          ...
          <select id="bloodgroup" type="text" class="input" data-type="text" name="bloodgroup">
         ...
         <div class="group">
          ...
          <select id="gender" type="text" class="input" data-type="text" name="gender">
        ...
        <div class="footer-left" name = "footer-left">
        <h3>Copyright @2022 Blood Bank Management System</h3></div>
    </body>
      </html>