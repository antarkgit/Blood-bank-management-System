  ...
  <div class="container-fluid">
    ...
    <div >
      <ul class="nav navbar-nav" >
        ...
        <li class="active" ><a href="home.php" style="background-color: blue; color: white; text-decoration: underline;">Back to Home</a></li>
         <li class="active"><a style="background-color: blue; color: white; text-decoration: underline;" href="prostatus.php">Status</a></li>
        <li class="active"><a style="background-color: blue; color: white; text-decoration: underline;" href="logout.php">Logout</a></li>
...
<select type='text' name="search" class="tf" placeholder='Enter Blood Group' style="width:200px;height:30px;" required>
