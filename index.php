...
<b><i background-color: red;>Hi, Welcome to our RSTU Blood Bank Management System. Save Lives. Join the Committee.</b></i>
</marquee>
    <section>
 <br>
  <div id="myCarousel" class="carousel slide" data-ride="carousel" >
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        ...
        <img src="images/don1.jpg" alt="Chania" width="460" height="345">
        <p></p>
      </div>
   
      <div class="item">
        <img src="images/don2.jpg" alt="Chania" width="460" height="345">
      </div>
    
      <div class="item">
        <img src="images/don3.jpg" alt="Flower" width="460" height="345">
      </div>

      <div class="item">
        
        <img src="images/img.jpg" alt="blood" width="460" height="345">
      </div>
    </div>
    ...
    <div class="container">
        <div class="col-md-8 main-section">
            <h2>Our Mission</h2>
            <p>
                 This blood bank will provide a sustained and effective humanitarian service committed to build resilient communities, ran by well-trained and dedicated staff and volunteers imbued with integrity, equipped with the necessary logistics and the maximum usage of information technology.
            </p>
            <p class="note">
        ...
        <div class="col-md-4">
           <div class="sidebar">
               <img src="images/Bloodhome.jpg" width="100%" height="345" alt="Blood Donation"/>
           </div>
        </div>
    </div>
