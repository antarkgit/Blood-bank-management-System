...
<div class="register">
              <form name="registration" method="POST" action="" enctype="multipart/form-data">
                <p>Massages </p>
                <input type="Massage" class="text" value=""  name="bid" required style= "width:650px;height:60px;"><br>
               
                <br><div class="sign-up">
                  <input type="submit" name="signup"  value="Send" style= "width:150px;">
                  <div class="clear"> </div>
                </div>
              </form>
