...
<body>
<p style="text-align:center;font-size:60px;font-family:cursive;color:black;background-color: red;color: white; border-radius:0.5px">Blood Bank Management System</p>
 ...
 <center>
  ...
  <a href="adminhome.php"style="color:black;font-size: 20px;" class="btn btn-primary">Back to home</a>
 	 <h3 style="color:black;font-size: 20px">Copyright@2022 Blood Management System</h3>
